...
public class NewYorkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (isConnected()) {
            ...
            weatherModel = helper.getOneCity("New York");
            showWeatherOffline(weatherModel);
            forecastModel = forecastDatabaseHelper.getOneCityForecast("New York");
    ...
    private void getWeather() {
        Call<Weather> callWeather = apiWeatherInterface.newYorkWeather();
    ...
    private void getForecast() {
        Call<Forecast> callForecast = apiWeatherInterface.newYorkForecast();
        callForecast.enqueue(new Callback<Forecast>() {
            ...
            public void onResponse(Call<Forecast> call, Response<Forecast> response) {
                ...
                forecastModel.setCityName("New York");
                //day1
