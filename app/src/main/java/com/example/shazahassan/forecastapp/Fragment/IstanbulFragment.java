...
public class IstanbulFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (isConnected()) {
            ...
            weatherModel = helper.getOneCity("Istanbul");
            showWeatherOffline(weatherModel);
            forecastModel = forecastDatabaseHelper.getOneCityForecast("Istanbul");
    ...
    private void getWeather() {
        Call<Weather> callWeather = apiWeatherInterface.istanbulWeather();
        callWeather.enqueue(new Callback<Weather>() {
            ...
            public void onResponse(Call<Weather> call, Response<Weather> response) {
                ...
                calendar.setTimeInMillis(sunriseHour * 1000L);
    ...
    private void getForecast() {
        Call<Forecast> callForecast = apiWeatherInterface.istanbulForecast();
        callForecast.enqueue(new Callback<Forecast>() {
            ...
            public void onResponse(Call<Forecast> call, Response<Forecast> response) {
                ...
                forecastModel.setCityName("Istanbul");
                //day1
