...
public class LondonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (isConnected()) {
            ...
            weatherModel = helper.getOneCity("London");
            showWeatherOffline(weatherModel);
            forecastModel = forecastDatabaseHelper.getOneCityForecast("London");
    ...
    private void getWeather() {
        Call<Weather> callWeather = apiWeatherInterface.londonWeather();
    ...
    private void getForecast() {
        Call<Forecast> callForecast = apiWeatherInterface.londonForecast();
        callForecast.enqueue(new Callback<Forecast>() {
            ...
            public void onResponse(Call<Forecast> call, Response<Forecast> response) {
                ...
                forecastModel.setCityName("London");
                //day1
